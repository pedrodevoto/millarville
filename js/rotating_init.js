...
$(document).ready(function() {
	...
	$('#slidebox .thumbs span:first-child').removeClass('thumb').addClass('selected_thumb');
	...
	if( !$("#slidebox .container").is(":animated")){
		if(slideTo=='next'){ //next
			...
			if(leftPosition==-slideboxTotalContent){
				...
				$('#slidebox .thumbs span:first-child').removeClass('thumb').addClass('selected_thumb');
				$('#slidebox .thumbs span:last-child').removeClass('selected_thumb').addClass('thumb');
			} else {
			...
			if(leftPosition=='0'){
				...
				$('#slidebox .thumbs span:last-child').removeClass('thumb').addClass('selected_thumb');
				$('#slidebox .thumbs span:first-child').removeClass('selected_thumb').addClass('thumb');
			} else {
			...
			if(leftPosition!=-slide2){
				...
				var selThumb=$('#slidebox .thumbs span').eq((slideTo-1));
