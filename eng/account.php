	...
	if (isset($_POST["update"]) && $_POST["update"]=="1") {		
		...
		switch (mysql_errno()) {
			case 0:						
				...
				break;
			case 1062:
				$message = "Error: The e-mail address is already in use. Please specify another.";							
				break;						
			default:
...
<title>Millarville Web Site - Your Account</title>
    ...
    <div id="main">    
    	...
    	<div id="content">  
            <div id="innercontent">  
            	...
            	<h1 class="header1">Your Account</h1>
                <hr />                      
                         
                <p class="f_white f_12">Update your information.<br /> 
