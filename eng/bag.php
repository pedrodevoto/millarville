...
<title>Millarville Web Site - Shopping Bag</title>
    ...
    <div id="main">    
    	...
    	<div id="content">  
            <div id="innercontent">  
            	...
            	<h1 class="header1">Shopping Bag</h1>
                <hr />
				...
				<?php
					...
					if (count($_SESSION['bag'])>0) {
						...
						echo '<div align="right" style="margin-top:20px"><input type="submit" name="submit" id="submit" value="REMOVE" /></div>';												
						echo '</form>';																						
						
						echo '<div align="right" style="margin-top:40px"><input type="button" name="continue" id="continue" value="CONTINUE SHOPPING" onclick="javascript:window.location=\'products.php\';" /><input type="button" name="checkout" id="checkout" value="CHECKOUT" onclick="javascript:window.location=\'checkout.php\';" /></div>';
						
					} else {
						echo '<p class="f_12 f_white">Shopping bag is empty.</p>';
