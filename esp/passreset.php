...
<?php
	...
	if (isset($_POST['reset']) && $_POST['reset']==1) {	
		...
		if ($foundUser) {
			...
			$body = "Su nueva clave es: ".$genpassword."\n\n";			
			$body .= "Una vez ingresado al sistema, puede modificar su información mediante la sección \"Mi Cuenta\".\n\n";
			...
			$error = "Error: No se encontró un usuario válido con la dirección de e-mail provista.";
...
<title>Millarville Web Site - Restablecer contraseña</title>
    ...
    <div id="main">    
    	...
    	<div id="content">  
            <div id="innercontent">  
            	...
            	<h1 class="header1">Restablecer contraseña</h1>
                <hr />
                <p class="f_12 f_white">Por favor ingrese la siguiente información para poder restablecer su contraseña:</p>				
                <form name="frmReset" id="frmReset" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="formReset">
                    ...
                    <p>
                        ...
                        <input type="submit" name="submit" id="submit" value="RESTABLECER" />
                    </p>
                </form>
                <?php
					if ($error!="") {
