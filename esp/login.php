...
<title>Millarville Web Site - Ingresar</title>
    ...
    <div id="main">    
    	...
    	<div id="content">  
            <div id="innercontent">  
            	...
            	<h1 class="header1">Ingresar</h1>
                <hr />
                
                <?php
					if(isset($_GET['register']) && $_GET['register']=="true") {
						echo '<p class="f_12 f_white" align="center"><strong>Registración exitosa. Por favor ingrese sus datos para continuar:</strong></p>';
					}
				?>
