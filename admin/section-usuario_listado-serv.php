...
<?php
	...
	$query_Recordset1_fields = " usuario_apellido, usuario_nombre, usuario_pais, usuario_empresa, usuario_email, (IF(usuario_passreset=1,'SI','NO')) AS usuario_passreset, usuario.usuario_id";
...
<?php
	...
	switch ($action) {
		...
		case "view":
			...
			$aColumns = array('usuario_apellido', 'usuario_nombre', 'usuario_pais', 'usuario_empresa', 'usuario_email', 'usuario_passreset', ' ', 'usuario_id');
