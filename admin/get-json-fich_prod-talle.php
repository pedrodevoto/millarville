...
<?php
	...
	$query_Recordset1 = sprintf("SELECT talle_nombre_es, talle_nombre_en, talle.talle_id FROM talle WHERE talle.producto_id=%s", GetSQLValueString($colname_Recordset1, "int"));
